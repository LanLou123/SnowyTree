...
class ShaderProgram {
  ...
  draw(d: Drawable) {
    ...
    if (this.attrBpos != -1) gl.disableVertexAttribArray(this.attrBpos);
    if (this.attrBlook != -1) gl.disableVertexAttribArray(this.attrBlook);
    if (this.attrBright != -1) gl.disableVertexAttribArray(this.attrBright);
